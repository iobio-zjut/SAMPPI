...
if __name__ == "__main__":
    ...
    for n in range(1,11):
        ...
        csv = pd.read_csv(f'{base_dir}/data/test_fold/M1101/M1101_test_fold{n}.csv',
        ...
        model_path = f'{base_dir}/save_models/M1101/model_{n}'  # 动态路径
        ...
        # 定义保存路径
        save_dir = f'{base_dir}/output/M1101'
        # 保存文件
