...
if __name__ == "__main__":
    ...
    for train_index, val_index in kf.split(interactions):
        ...
        # 定义目标路径
        output_dir = f'{base_dir}/output/S645'
        ...
        file_best_pcc_PCCS = f'{base_dir}/output/S645/RECORD_{}.txt'.format(i)
        file_best_pcc_model = f'{base_dir}/output/S645/model_{}'.format(i)
